    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            */
            ...
            Array.Copy(smallArray, 0, newSmallArray, 0, smallArray.Length);
            ...
            * Large array
            */
            //create a Large array (10,000)
            int[] largeArray = getArray(10000, 1000000);

            //Deep copy to a new array used for removing duplicates
            int[] newLargeArray = new int[largeArray.Length];
            Array.Copy(largeArray, 0, newLargeArray, 0, largeArray.Length);

            //Deep a copy to another array used for quick sorting
        ...
        { 
            ...
            if (debug)
            {
                Console.WriteLine("Array before the" + "sort");
            ...
            //Get the line elapsed for waiting
        ...
        //Peform the bubble sort

        private static void bubbleSort(int[] intArray)
        {
            /*
             * In bubble sort, we basically traverse the array from first to array.length -
